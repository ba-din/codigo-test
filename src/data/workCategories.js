...
export const works = [
  ...
  { label: 'Ready To Travel (SATS)', styleClass: 'workGrid__gridItem workGrid__colWidth--span2', img: 'https://cdn.codigo.co/uploads/2021/04/RTT-0@2x.jpg', cat: [5, 8], legends: [0, 1, 2, 3] },
  ...
  { label: 'ComfortDelGro', styleClass: 'workGrid__gridItem', img: 'https://cdn.codigo.co/uploads/2018/08/CDG-2-1.jpg', cat: [3], legends: [0] },
